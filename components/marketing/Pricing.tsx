...
const plans = [
  {
    ...
    features: [
      "All 3 workout types — forever free",
      "AI workout generation",
      "Exercise GIF demos",
      "AI Coach chat (10/day)",
      "7-day free AI diet plan",
      "Progress tracking",
    ],
    cta: "Start Free",
    href: "/sign-up",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-500 max-w-2xl mx-auto">
            Workouts are always free. 7-day diet trial included. No credit card required.
          </p>
        </div>

        {/* Early Bird Banner */}
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-4 text-center mb-12 flex items-center justify-center gap-3 flex-wrap">
          <Flame className="w-5 h-5 text-amber-500 flex-shrink-0" />
          <p className="text-amber-800 font-semibold text-sm">
            🔥 Early Bird: First 1000 users get{" "}
            <strong>75% OFF forever</strong> — ₹499 → ₹125/month
          </p>
          <Flame className="w-5 h-5 text-amber-500 flex-shrink-0" />
        </div>
