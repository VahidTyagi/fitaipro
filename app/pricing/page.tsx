...
export default async function PricingPage() {
  ...
  { text: "30-day AI diet plan", included: true },
  { text: "AI Coach — 100 messages/day", included: true },
  { text: "Meal photo calorie analysis", included: true },
  { text: "Custom lifestyle plan builder", included: true },
  { text: "Progress analytics & charts", included: true },
  { text: "Unlimited AI coaching sessions", included: false },
  { text: "Body video progress tracking", included: false },
  { text: "1-on-1 AI coach sessions", included: false },
  { text: "Priority support (WhatsApp)", included: false },
      ],
    },
    {
      id: "elite",
